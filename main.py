...
# main function
print("LEAGUE")
print("#Please Enter Fulltime Score(number) for each team for each game \nYou'll be given a team and be required to "
      "enter the score(number)#\n e.g \n #Springboks VS All Blacks \n Springboks: 26 \n All Blacks: 10 \n NOW , "
      "LETS GO! enter the score for the team below and press enter to move to the next\n")
